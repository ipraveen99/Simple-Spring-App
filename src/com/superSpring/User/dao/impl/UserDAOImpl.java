package com.superSpring.User.dao.impl;

import com.superSpring.User.dao.UserDAO;
...
public class UserDAOImpl extends JdbcDaoSupport implements UserDAO {
    ...
    // update user details
    private static final String UPDATE_USER_SQL = " update user set name = ?, pass = ?, role = ? where id = ?";
